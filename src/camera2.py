...
class Camera():
    ...
    def __init__(self, calibrationPholder="../camera_cal"):
        self.ret = None
        self.mtx = None
        self.dist = None
        self.rvecs = None
        self.tvecs = None
        self.imageSize = None
        self.calibrationPholder = calibrationPholder+"/calibration*.jpg"


        print ("hello calibrationPholder=", calibrationPholder)

        # Read in a calibration image
        images  = glob.glob(relativePholder)
        #plt.imshow(img)
        #plt.show()
